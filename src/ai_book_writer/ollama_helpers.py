...
研究データ:
```
{research_data[:9000]}  # 長すぎる場合は最初の部分のみ使用
```
...
5. ３つのパターンから考慮してください
6. パターン１：ブログなどの文章を書く場合は、最初につかみの章を書き、終わりには結論の部分を書いてください
7. パターン２：プログラミングについての文章を期待している場合は、実際のコードの使い方を中心に書いてください
8. パターン３：小説について書いてほしい場合は文章の展開を考慮したうえでそれぞれの場面でどのように変化するのかを書いてください
"""
...
以下の研究データを参考にしてください:
```
{research_data[:10000]}  # 長すぎる場合は最初の部分のみ使用
```
